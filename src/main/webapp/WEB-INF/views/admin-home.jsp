...
<section id="help" class="help">
    ...
    <div class="help--slides active" data-id="1">
        ...
        <ul class="help--slides-items">
            ...
            <li>
                ...
                <div class="col">
                    ...
                    <div>
                        ...
                        <form action="/admin/institution/delete" method="post" style="padding: 1px; margin: 1px">
                            <button class="btn" name="institutionId" value="${institution.id}"
            ...
            <form action="/admin/institution/add" method="post">
                <li>
                    <div class="col">
                        <div class="title">
...
<div class="col">
    <form action="/admin/update" method="get" style="padding: 1px; margin: 1px">
        <button name="editUserId" value="${user.userId}"
                style="font-size: small; border-radius: 5px; border-width: 1px; color: limegreen">Edytuj
        </button>
    </form>
    <form action="/admin/delete/confirm" method="post" style="padding: 1px; margin: 1px">
        <button name="deleteUserId" value="${user.userId}"
                style="font-size: small; border-radius: 5px; border-width: 1px; color: red">Usuń
        </button>
    </form>
</div>