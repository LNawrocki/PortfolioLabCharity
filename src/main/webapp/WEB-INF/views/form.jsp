                ...
                <div class="summary">
                    ...
                    <div class="form-section form-section--columns">
                        <div class="form-section--column">
                            <h4>Adres odbioru:</h4>
                            <ul>
                                <li>Nie podano ulicy</li>
                                <li>Nie podano miasta</li>
                                <li>Nie podano kodu pocztowego</li>
                                <li>Nie podano telefonu</li>
                            </ul>
                        </div>
                        ...
                        <div class="form-section--column">
                            <h4>Termin odbioru:</h4>
                            <ul>
                                <li>Nie podano daty odbioru</li>
                                <li>Niepodano godziny odbioru</li>
                                <li>Brak uwag</li>
                            </ul>
                        </div>
                    </div>
